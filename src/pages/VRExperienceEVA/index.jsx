    ...
    return(
        <div className="container">
            <section className="container__eva">
                ...
                <video controls>
                    <source src="/assets/video-EVA.mp4" type="video/mp4"/>
                </video>
                <p>EVA is a unique and cutting-edge technology that was introduced to the world at Paris Games Week 2019 for the first time. EVA provides the ULTIMATE VR Esports experience.</p>
